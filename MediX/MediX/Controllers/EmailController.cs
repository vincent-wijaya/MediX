...
namespace MediX.Controllers
{
    public class EmailController : Controller
    {
        ...
        public async Task<bool> SendEmail(string toEmail, string toName, string subject, string plainTextContent, string htmlContent)
        {
            var from = new EmailAddress("vincentwijayaaaaa@gmail.com", "MediX");
            var toRecipient = new EmailAddress(toEmail, toName);
            var msg = MailHelper.CreateSingleEmail(from, toRecipient, subject, plainTextContent, htmlContent);
